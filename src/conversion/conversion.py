class Conversion:
    ...
    def metros_a_pies(self, metros):
        ...
        """
        conv_metros_pies = metros * 3.28084
        return conv_metros_pies
    ...
    def pies_a_metros(self, pies):
        ...
        """
        conv_pies_metros = pies * 0.3048
        return conv_pies_metros
    ...
    def binario_a_decimal(self, binario):
        ...
        """
        conv_bin_a_decimal = int(binario,2)
        return conv_bin_a_decimal
    ...
    def romano_a_decimal(self, romano):
        ...
        for i in range (len(romano)):
            numeroActual = numerosromanos[romano[i]]
            
            if i + 1 < len(romano):
                siguienteNumero = numerosromanos[romano[i+1]]
